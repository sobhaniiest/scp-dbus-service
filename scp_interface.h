...
void scp_interface_new_printer_dialog_complete_on_dialog_canceled (
    scpinterfaceNewPrinterDialog *object,
    GDBusMethodInvocation *invocation);

void scp_interface_new_printer_dialog_complete_on_printer_added (
    scpinterfaceNewPrinterDialog *object,
    GDBusMethodInvocation *invocation);

void scp_interface_new_printer_dialog_complete_on_printer_modified (
    scpinterfaceNewPrinterDialog *object,
    GDBusMethodInvocation *invocation);

void scp_interface_new_printer_dialog_complete_on_driver_download_checked (
    scpinterfaceNewPrinterDialog *object,
    GDBusMethodInvocation *invocation);
...
void scp_interface_new_printer_dialog_emit_driver_download_cheked (
    scpinterfaceNewPrinterDialog *object);
...
void scp_interface_new_printer_dialog_call_on_dialog_canceled (
    scpinterfaceNewPrinterDialog *proxy,
    GCancellable *cancellable,
    GAsyncReadyCallback callback,
    gpointer user_data);

gboolean scp_interface_new_printer_dialog_call_on_dialog_canceled_finish (
    scpinterfaceNewPrinterDialog *proxy,
    GAsyncResult *res,
    GError **error);

gboolean scp_interface_new_printer_dialog_call_on_dialog_canceled_sync (
    scpinterfaceNewPrinterDialog *proxy,
    GCancellable *cancellable,
    GError **error);

void scp_interface_new_printer_dialog_call_on_printer_added (
    scpinterfaceNewPrinterDialog *proxy,
    const gchar *arg_name,
    GCancellable *cancellable,
    GAsyncReadyCallback callback,
...
gboolean scp_interface_new_printer_dialog_call_on_printer_added_finish (
    scpinterfaceNewPrinterDialog *proxy,
    GAsyncResult *res,
    GError **error);

gboolean scp_interface_new_printer_dialog_call_on_printer_added_sync (
    scpinterfaceNewPrinterDialog *proxy,
    const gchar *arg_name,
    GCancellable *cancellable,
    GError **error);

void scp_interface_new_printer_dialog_call_on_printer_modified (
    scpinterfaceNewPrinterDialog *proxy,
    const gchar *arg_name,
    gboolean arg_ppd_has_changed,
    GCancellable *cancellable,
...
gboolean scp_interface_new_printer_dialog_call_on_printer_modified_finish (
    scpinterfaceNewPrinterDialog *proxy,
    GAsyncResult *res,
    GError **error);

gboolean scp_interface_new_printer_dialog_call_on_printer_modified_sync (
    scpinterfaceNewPrinterDialog *proxy,
    const gchar *arg_name,
    gboolean arg_ppd_has_changed,
    GCancellable *cancellable,
...
void scp_interface_new_printer_dialog_call_on_driver_download_checked (
    scpinterfaceNewPrinterDialog *proxy,
    GVariant *arg_installed_files,
    GCancellable *cancellable,
    GAsyncReadyCallback callback,
...
gboolean scp_interface_new_printer_dialog_call_on_driver_download_checked_finish (
    scpinterfaceNewPrinterDialog *proxy,
    GAsyncResult *res,
    GError **error);

gboolean scp_interface_new_printer_dialog_call_on_driver_download_checked_sync (
    scpinterfaceNewPrinterDialog *proxy,
    GVariant *arg_installed_files,
    GCancellable *cancellable,
    GError **error);
